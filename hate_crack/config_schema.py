...
CONFIG_SCHEMA: tuple[ConfigKey, ...] = (
    ...
    ConfigKey("HCAT_WORDLISTS", "hcatWordlists", "path", "./wordlists"),
    ConfigKey(
    ...
    ConfigKey("RULES_DIRECTORY", "rules_directory", "path", "./hashcat/rules"),
    ConfigKey(
    ...
    ConfigKey("HCAT_HYBRIDLIST", "hcatHybridlist", "str", ["rockyou.txt"]),
    ConfigKey(
    ...
    ConfigKey("PIPAL_COUNT", "pipal_count", "str", 10),
    ConfigKey("BANDRELMAXRUNTIME", "bandrelmaxruntime", "str", 300),
    ConfigKey(
    ...
    ConfigKey("OLLAMA_TIMEOUT", "ollamaTimeout", "float", 300.0),
